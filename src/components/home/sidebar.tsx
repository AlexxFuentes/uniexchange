...
export default function Sidebar() {
    ...
    return (
        ...
        <div className="hidden sm:flex flex-col p-2 xl:items-start h-screen xl:ml-10">
            ...
            {user && (
                <div className={`${pathname === "/university" ? "hoverUniversityProfiel" : ""} hover:hoverUniversityProfiel relative flex items-center justify-center xl:justify-start px-[2px] mt-5`}>
                    <Link href={`/home/profile/${user?.uid}`} className="flex items-center">
                        <Image
            ...
            <div className="mt-4 mb-2.5 xl:items-start w-full flex flex-col gap-5 border-t-[1px] border-t-silverSand pt-5">
                {
                    !user && (
                        <SidebarMenuItem text="Inicio" Icon={HomeIcon} active link="/" />
                    )
                }
                {user && (
                    <>
                ...
                <SidebarMenuItem text="Universidades" Icon={LibraryIcon} link="/home/universities" />
            </div>
